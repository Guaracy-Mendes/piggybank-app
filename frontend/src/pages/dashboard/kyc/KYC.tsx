...
const KYC: React.FC = () => {
    const [kyc, setKyc] = React.useState<any | null>(null);
                                    ...
                                    <form className="space-y-5" noValidate onSubmit={handleSubmit}>
                                        ...
                                        <div>
                                            ...
                                            <div className="relative">
                                                ...
                                                <input type="text" value={fullName} onChange={(e) => setFullName(e.target.value)} disabled={alreadySubmitted} placeholder="As shown on your ID" className="w-full rounded-xl border border-gray-300 bg-white px-9 py-2 text-sm text-gray-900 placeholder:text-gray-400 outline-none ring-0 transition focus:border-gray-400 dark:border-white/10 dark:bg-transparent dark:text-white dark:placeholder:text-white/50" />
                                            </div>
                                        </div>
                                        ...
                                        <div>
                                            ...
                                            <div className="relative">
                                                ...
                                                <input type="date" value={dob} onChange={(e) => setDob(e.target.value)} className="w-full rounded-xl border border-gray-300 bg-white px-9 py-2 text-sm text-gray-900 placeholder:text-gray-400 outline-none ring-0 transition focus:border-gray-400 dark:border-white/10 dark:bg-transparent dark:text-white" />
                                            </div>
                                        </div>
                                        ...
                                        <div>
                                            ...
                                            <div className="relative">
                                                ...
                                                <select value={idType} onChange={(e) => setIdType(e.target.value)} disabled={alreadySubmitted} className="w-full appearance-none rounded-xl border border-gray-300 bg-white px-9 py-2 text-sm text-gray-900 outline-none ring-0 transition focus:border-gray-400 dark:border-white/10 dark:bg-transparent dark:text-white" defaultValue="NATIONAL_ID">
                                        ...
                                        <div className="grid grid-cols-1 gap-3 sm:grid-cols-2">
                                            <div>
                                                ...
                                                <input value={idImageUrl} onChange={(e) => setIdImageUrl(e.target.value)} disabled={alreadySubmitted} type="url" placeholder="https://…" className="w-full rounded-xl border border-gray-300 bg-white px-3 py-2 text-sm text-gray-900 placeholder:text-gray-400 outline-none ring-0 transition focus:border-gray-400 dark:border-white/10 dark:bg-transparent dark:text-white dark:placeholder:text-white/50" />
                                        ...
                                        <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
                                            <div className="rounded-2xl border border-gray-200 bg-gray-50 p-4 dark:border-white/10 dark:bg-black/40">
                                                ...
                                                <div className="mt-2 overflow-hidden rounded-xl border border-gray-200 dark:border-white/10">
                                                    <div className="grid h-48 place-items-center text-xs text-gray-500 dark:text-white/50">{idImageUrl ? <img src={idImageUrl} alt="ID Preview" className="h-48 w-full object-contain" /> : "No image selected"}</div>
                                                </div>
                                            </div>
